...
class MainActivity : AppCompatActivity() {
    ...
    private fun fillFields() {
        tvPlayerOneName.text = intent.getStringExtra(PlayerActivity.KEY_EXTRA_PLAY_ONE);
        tvPlayerTwoName.text = intent.getStringExtra(PlayerActivity.KEY_EXTRA_PLAY_TWO);
    }
